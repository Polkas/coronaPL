...
zip_path, _ = request.urlretrieve(main_url + pow_sha + "/data")
with zipfile.ZipFile(zip_path, "r") as f:
    f.extractall(path_data)

zip_path, _ = request.urlretrieve(main_url + woj_sha + "/data")
with zipfile.ZipFile(zip_path, "r") as f:
    f.extractall(path_data)

zip_path, _ = request.urlretrieve(main_url + all_vac_sha + "/data")
with zipfile.ZipFile(zip_path, "r") as f:
    f.extractall(path_data)
